...
For each ($mh; Form:C1466.workingPeriods.medicalHouses)
	APPEND MENU ITEM:C411($menu; $mh.name)
	SET MENU ITEM PARAMETER:C1004($menu; -1; $mh.UUID)
End for each 
...
Case of 
	...
	: ($choose#"")
		Form:C1466.current_appointment.UUID_MedicalHouse:=$choose
