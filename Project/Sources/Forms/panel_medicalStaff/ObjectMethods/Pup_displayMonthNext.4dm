...
Case of 
	: ($ref="")
	: ($ref#"")
		Form:C1466.calendar.display.month:=Num:C11($ref)-1
		If (Form:C1466.calendar.display.month=0)
			Form:C1466.calendar.display.month:=12
			Form:C1466.calendar.display.year:=Form:C1466.calendar.display.year-1
		End if 
