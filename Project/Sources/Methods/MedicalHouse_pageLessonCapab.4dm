...
If (String:C10(Form:C1466.current_item.UUID)#"")
	If (String:C10(Form:C1466.calculation.loadlessonCapabilitiesForUUID)#Form:C1466.current_item.UUID)
		...
		If (Form:C1466.current_item.lessonCapabilities#Null:C1517)
			Activity_load_cache
			Form:C1466.lb_lessonCapabilities:=Form:C1466.current_item.lessonCapabilities.toCollection("*, coach.*").extract("UUID"; "UUID"; "UUID_Coach"; "UUID_Coach"; "UUID_Activity"; "UUID_Activity"; "coach.civility"; "civility"; "coach.lastName"; "lastName"; "coach.firstName"; "firstName"; "schedule"; "schedule")
			For each ($lessonCapability; Form:C1466.lb_lessonCapabilities)
				$lessonCapability.activity:=Activity_getFromCache($lessonCapability.UUID_Activity).name
			End for each 
		Else 
