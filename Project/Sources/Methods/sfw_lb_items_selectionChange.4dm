...
If (Form:C1466.current_item#Null:C1517)
	...
	If ($current_panel#Form:C1466.entry.panel.name)
		OBJECT SET SUBFORM:C1138(*; "detail_panel"; String:C10(Form:C1466.entry.panel.name))  // String is mandatory to help the compilator
	Else 
